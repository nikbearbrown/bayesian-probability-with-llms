...
**Nik Bear Brown** teaches probability, statistics, AI, and data science at Northeastern University. His PhD in Computer Science from UCLA was in computational and systems biology, with secondary fields in artificial intelligence and statistics. Bayesian reasoning runs through much of his applied work, from the Madison Framework for marketing intelligence to the *Computational Skepticism for AI* method.

He is the founder of [Humanitarians AI](https://www.humanitarians.ai/), the architect of the **Brutalist** AI-assisted production framework, and the author of the *with LLMs* textbook series.
